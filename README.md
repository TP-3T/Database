...
* `pnpm prisma db push` for prototyping/development on db schema
* `npm prisma migrate dev` to generate your db migration
...
## PlantUML
* The shortcut to preview the tables in the schema.puml file is:
* `alt + D` 